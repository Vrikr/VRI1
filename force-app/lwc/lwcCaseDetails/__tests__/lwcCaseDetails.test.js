...
import LwcCaseDetails from 'c/lwcCaseDetails';

describe('c-lwc-case-details', () => {
    afterEach(() => {
...
// Helper function to wait until the microtask queue is empty. This is nee
//ded for promise
 ...
 // Create element
 const element = createElement('c-lwc-case-details', {
 is: LwcCaseDetails
 });
 ...
 document.body.appendChild(element);
 const OUTPUT_FIELDS = ['CreatedDate', 'Status', 'Priority'];
